          ...
          <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <span className={`inline-block px-3 py-1 rounded-full text-xs font-bold mt-1 ${
                    dispute.status === 'Open' ? 'bg-red-100 text-red-800 border border-red-300' :
            ...
            {dispute.seller && dispute.seller.paymentDetails && (
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                <p className="text-sm font-semibold text-slate-600 mb-3">Seller Payment Details (Refund Will Be Processed)</p>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {dispute.seller.paymentDetails.stripeAccountId && (
                    <div className="col-span-2">
                      <p className="text-xs text-slate-600">Stripe Account ID</p>
                      <p className="text-sm font-mono text-slate-900">{dispute.seller.paymentDetails.stripeAccountId}</p>
                    </div>
                  )}
                </div>
              </div>
